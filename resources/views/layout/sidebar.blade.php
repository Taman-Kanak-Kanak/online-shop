    <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
        ...
        <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
            ...
            <a href="index.html">
                ...
                <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="{{ Vite::asset('resources/images/logo/logo-icon.svg') }}"
                    alt="Logo" />
            </a>
        </div>
        <!-- SIDEBAR HEADER -->
                    ...
                    <ul class="mb-6 flex flex-col gap-4">
                        ...
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'Task' ? '':'Task')"
                                ...
                                <svg :class="(selected === 'Task') || (page === 'taskList' || page === 'taskKanban') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <ul class="mb-6 flex flex-col gap-4">
                        ...
                        <li>
                            <a href="chat.html" @click="selected = (selected === 'Chat' ? '':'Chat')"
                                ...
                                <svg :class="(selected === 'Chat') && (page === 'chat') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'Email' ? '':'Email')"
                                ...
                                <svg :class="(selected === 'Email') || (page === 'inbox' || page === 'inboxDetails') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li>
                            <a href="invoice.html" @click="selected = (selected === 'Invoice' ? '':'Invoice')"
                                ...
                                <svg :class="(selected === 'Invoice') && (page === 'invoice') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
